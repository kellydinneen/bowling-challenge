...
describe('totalScore', () => {
  ...
  it.skip('scores game with spares', () => {
  ...
  it.skip('scores game with strikes', () => {
  ...
  it.skip('scores game with consecutive strikes', () => {
  ...
  it.skip('scores game with spare after strike', () => {
